...
<style>
  ...
  html[data-theme="dark"] .pub-title a:hover { color: #3ECF8E; }
  html[data-theme="dark"] .venue-tag { border-color: #3ECF8E; color: #3ECF8E; }
  html[data-theme="dark"] .pub-links a { color: #3ECF8E; text-decoration-color: rgba(62, 207, 142, 0.4); }
  html[data-theme="dark"] .pub-links a:hover { text-decoration-color: #3ECF8E; }
  ...
  html[data-theme="dark"] .pub-title a { color: var(--global-text-color); }
  .venue-tag {
